...
const { viewDepartments, viewRoles, viewEmployees, viewEmployeesByManager, viewEmployeesByDepartment, calculateTotalBudget} = require('./viewchoices'); // Import view actions
    ...
    try {
        ...
        while (!exit) {
            ...
            switch (choice.action) {
                ...
                //    const managerId = // obtain managerId from user input

        ...
        while (!exit) {
            ...
            switch (choice.action) {
                case 'Department Options':
                    await handleDepartmentOptions(); // Function to handle department-related action menu select
                    break;
                case 'Employee Options':
                    await handleEmployeeOptions(); // Function to handle employee-related actions
                    break;
                case 'Role Options':
                    await handleRoleOptions(); // Function to handle role-related actions
                    break;

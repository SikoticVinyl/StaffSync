...
const { viewDepartments, viewRoles, viewEmployees, viewEmployeesByManager, viewEmployeesByDepartment, calculateTotalBudget, promptEmployeesByMID} = require('./viewchoices'); // Import view actions

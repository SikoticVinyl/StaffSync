...
const { viewDepartments, viewRoles, viewEmployees, promptEmployeesByM, viewEmployeesByM, viewEmployeesByDepartment, calculateTotalBudget} = require('./viewchoices'); // Import view actions

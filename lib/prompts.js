...
const { viewDepartments, viewRoles, viewEmployees, promptEmployeesByMID, viewEmployeesByMID, viewEmployeesByDepartment, calculateTotalBudget} = require('./viewchoices'); // Import view actions
        ...
        while (!exit) {
            ...
            switch (choice.action) {
                ...
                case 'View employees by manager(ID)':
                    console.log('View Employees by Manager ID case selected');
                    const managerId = await promptEmployeesByMID();
                    await viewEmployeesByMID(managerId);
                    break;
                //case 'View employees by department':
                    //const departmentId = // obtain departmentId from user input

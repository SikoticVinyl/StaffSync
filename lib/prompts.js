...
const { promptDeleteEmployee, deleteEmployee, promptDeleteDepartment, deleteDepartment,  } = require('./deletechoices'); // Import delete actions
        ...
        while (!exit) {
            ...
            switch (choice.action) {
                ...
                case 'Delete department':
                    ...
                    //const  = await promptDeleteDepartment();
                    //await deleteDepartment();
                    break;
                case 'Delete role':
                    console.log('Delete role case selected');
                    //const  = await promptDeleteRole();
                    //await deleteRole(); 
                    break;
